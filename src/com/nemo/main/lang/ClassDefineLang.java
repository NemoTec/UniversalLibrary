 ...
 *     No01.[Class - Access Modifier: public]        |public        |public类可以被所有类访问;        |public类必须定义在同名文件中;一个java文件可以没有public类;
 *     No02.[Class - Access Modifier: none]          |无            |该类只可被同包中的类访问;        |默认的访问修饰符;一个java文件可以没有同名的类，但它们必须全是包级可访问权限。
 *
 *     ----------------------------------------
 *     1.2 Modifier(修饰符)
 ...
 *     顶级类,有ClassDefineLang, Plugin, Container. 
